  ...
  app: {
    head: {
      ...
      link: [
        ...
        {
          rel: 'stylesheet',
          href: 'https://fonts.googleapis.com/css2?family=Instrument+Sans:wght@400;500;600&family=Inter:wght@400;500;600;700&family=Manrope:wght@400;600&family=Montserrat:wght@500;600&family=Playfair+Display:ital,wght@0,500;0,600;0,700;1,500&display=swap',
        },
        {
          rel: 'stylesheet',
